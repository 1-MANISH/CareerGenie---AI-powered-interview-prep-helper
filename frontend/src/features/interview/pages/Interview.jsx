...
const Interview = () => {
        ...
        const {  handleGetInterviewReport, loading, report,handleGenerateResumePdf,generateLoading } = useInterview()
        const { interviewId } = useParams()

            useEffect(() => {
                if (interviewId ) {
                        const fetchReport = async () => {
                                await handleGetInterviewReport(interviewId)
                        }
                        fetchReport()
                }
            }, [  ])
        ...
        return (
                ...
                <div className='interview-layout'>
                        ...
                        <button
                                ...
                                {generateLoading ? 'Generating PDF...' : 'Generate PDF'}
                        </button>
                        </nav>
